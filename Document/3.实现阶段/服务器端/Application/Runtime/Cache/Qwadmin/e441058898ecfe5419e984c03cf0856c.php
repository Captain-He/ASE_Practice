                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="col-xs-10 col-sm-5">
                                        <?php echo UpImage("thumbnail",100,100,$article['thumbnail']);?>
                                    </div>
                                    <span class="help-inline col-xs-12 col-sm-7">
...
<script type="text/javascript">
    $(function () {
        ...
        var editor = KindEditor.create('textarea[name="content"]', {
            uploadJson: '/xcx/Public/kindeditor/php/upload_json.php',
            fileManagerJson: '/xcx/Public/kindeditor/php/file_manager_json.php',
